...
// Keyed by device.id in CheckoutScreen, so it mounts fresh for each device
// with the correct default price and date — no effect-based reset needed.
function CheckoutForm({ device }: { device: Device }) {
...
export default function CheckoutScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ headerShown: false }} />
      <CheckoutForm key={device.id} device={device} />
    </>
  );
}
